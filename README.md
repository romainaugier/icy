...
| `std::string_view` | 512 | **3.133** | 36.847 | 5.246 | 4.592 | 22.661 |
| `std::string_view` | 1024 | **3.228** | 44.393 | 5.278 | 4.595 | 23.987 |
| `std::int64_t` | 16 | **0.742** | 1.945 | 0.802 | 1.114 | 2.396 |
| `std::int64_t` | 512 | 1.055 | 6.954 | **0.935** | 0.979 | 6.257 |
| `std::int64_t` | 1024 | 0.994 | 7.498 | **0.888** | 0.967 | 7.498 |
...
| `std::string_view` | 512 | **3.031** | 38.596 | 4.902 | 4.748 | 21.927 |
| `std::string_view` | 1024 | **2.934** | 43.786 | 4.971 | 4.282 | 23.696 |
| `std::int64_t` | 16 | **0.636** | 2.208 | 1.216 | 0.915 | 2.381 |
| `std::int64_t` | 512 | 0.928 | 8.540 | 1.408 | **0.673** | 6.234 |
| `std::int64_t` | 1024 | 0.944 | 8.522 | 1.022 | **0.803** | 7.622 |
